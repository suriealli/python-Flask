...
StyleSwitcher.prototype.build = function () {
    ...
    $('body').css({
        'background-image': 'url(' + imgPath + '/static/img/pattern/' + $this.storageManager.getBgImage() + '.png)',
    ...
    if (itm.ci) {
        ...
        var colorSelStyle = $('<link/>')
            .attr({
                'rel': 'stylesheet',
                'href': imgPath + '/static/lib/colorpicker/css/colorpicker.css'
            }),
            colorSelHackStyle = $('<link/>').attr({
                'rel': 'stylesheet',
                'href': imgPath + '/static/css/colorpicker_hack.css'
            });
        ...
        var url = imgPath + '/static/lib/colorpicker/js/bootstrap-colorpicker.js';
    ...
    $.each(patternImages, function (i) {
        var listElement = $('<li/>').append($('<a/>').css({
                'background': 'url(' + imgPath + '/static/img/pattern/' + patternImages[i].image + '.png) repeat'
            }).attr({
                'href': '#',
    ...
    patternList.find('a').on(Metis.buttonPressedEvent, function (e) {
        e.preventDefault();
        $('body').css({
            'background-image': 'url(' + imgPath + '/static/img/pattern/' + $(this).data('patternImage') + '.png)',
            'background-repeat': ' repeat'
        });
